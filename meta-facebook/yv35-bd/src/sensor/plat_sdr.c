...
SDR_Full_sensor plat_sensor_table[] = {
 ...
 {   // SINGLE_FAN_BMC_TACH_4
   ...
   Self_I2C_ADDRESS<<1,   // owner id
   0x00,   // owner lun
   SENSOR_NUM_SINGLE_FAN_BMC_TACH_4,    // sensor number
 ...
 {   // SINGLE_FAN_BMC_TACH_5
   ...
   Self_I2C_ADDRESS<<1,   // owner id
   0x00,   // owner lun
   SENSOR_NUM_SINGLE_FAN_BMC_TACH_5,    // sensor number
 ...
 {   // SINGLE_FAN_BMC_TACH_6
   ...
   Self_I2C_ADDRESS<<1,   // owner id
   0x00,   // owner lun
   SENSOR_NUM_SINGLE_FAN_BMC_TACH_6,    // sensor number
 ...
 {   // SINGLE_FAN_BMC_TACH_7
   ...
   Self_I2C_ADDRESS<<1,   // owner id
   0x00,   // owner lun
   SENSOR_NUM_SINGLE_FAN_BMC_TACH_7,    // sensor number
