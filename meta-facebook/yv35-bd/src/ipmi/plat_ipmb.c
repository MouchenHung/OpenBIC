...
//  index                  interface      interface_source    bus                    Target_addr              EnStatus    slave_addr           Rx_attr_name                Tx_attr_name//
  { SLOT1_BIC_IPMB_IDX,    I2C_IF,        SLOT1_BIC_IFs,      IPMB_SLOT1_BIC_BUS,    SLOT1_BIC_I2C_ADDRESS,   Enable,     Self_I2C_ADDRESS,    "RX_SLOT1_BIC_IPMB_TASK",   "TX_SLOT1_BIC_IPMB_TASK"},
  { SLOT3_BIC_IPMB_IDX,    I2C_IF,        SLOT3_BIC_IFs,      IPMB_SLOT3_BIC_BUS,    SLOT3_BIC_I2C_ADDRESS,   Enable,     Self_I2C_ADDRESS,    "RX_SLOT3_BIC_IPMB_TASK",   "TX_SLOT3_BIC_IPMB_TASK"},
