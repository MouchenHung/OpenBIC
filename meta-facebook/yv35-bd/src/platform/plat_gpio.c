...
//  Defalut              DISABLE  DISABLE    GPIO_INPUT    LOW         PUSH_PULL    GPIO_INT_DISABLE       NULL
  { chip_gpio,  0,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              }, // GPIO A group
  { chip_gpio,  1,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  2,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_EDGE_RISING,  IRS_PWROK_SLOT1   },
  { chip_gpio,  3,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  4,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  5,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  ...
  { chip_gpio,  9,       ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  ...
  { chip_gpio,  13,      ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_EDGE_RISING,  IRS_PWROK_SLOT3   },
  ...
  { chip_gpio,  16,      ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              }, // GPIO C group
  ...
  { chip_gpio,  28,      ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  29,      ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  30,      ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              },
  ...
  { chip_gpio,  40,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              }, // GPIO F group
  { chip_gpio,  41,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  42,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  43,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  { chip_gpio,  44,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  ...
  { chip_gpio,  47,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  ...
  { chip_gpio,  50,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_HIGH,  OPEN_DRAIN,  GPIO_INT_DISABLE,      NULL              },
  ...
  { chip_gpio,  56,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              }, // GPIO H group
  ...
  { chip_gpio,  64,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              }, // GPIO I group
  ...
  { chip_gpio,  72,      DISABLE, DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              }, // GPIO J group
  ...
  { chip_gpio,  96,      ENABLE , DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              }, // GPIO M group
  ...
  { chip_gpio,  104,     ENABLE,  DISABLE,   GPIO_INPUT,   GPIO_LOW,   PUSH_PULL,   GPIO_INT_DISABLE,      NULL              }, // GPIO N group
